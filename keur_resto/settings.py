"""
Django settings for keur_resto project.
...
SECRET_KEY = 'django-insecure-o&#&_6&rcews66+gg)(&_v7^^-biz+#9kavwk&4p3#$%qx+*yy'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Ajouté pour CORS (doit être en haut)
...
WSGI_APPLICATION = 'keur_resto.wsgi.application'
